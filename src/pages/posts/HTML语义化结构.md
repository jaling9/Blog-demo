...
<head>
	...
	<script async defer nomodule src="fallback.js"></script>
...
<table>
  ...
  <tbody>表身体
    <tr> 第二行
      ...
      <th scope="row">Full color</th>行标题
      <td>A2</td> 数据的单元格
      <td>A3</td>
      <td>A4</td>
    </tr>
    <tr> 第三行
      <th scope="row">Black and white</th>行标题
      <td>A1</td>
      <td>A2</td>
      <td>A3</td>
    </tr>
    <tr>第四行
      <th scope="row">Sepia</th>行标题
      <td>A3</td>
      <td>A4</td>
      <td>A5</td>
    </tr>
